...
\begin{itemize}
    \item 16 GB de RAM DDR4
    \item Ryzen 5 1600X (12 núcleos, ~3.6GHz)
\end{itemize}
Foram utilizados os seguintes softwares:
\begin{itemize}
    \item Sistema Operacional: Ubuntu 22.04 Jammy Jellyfish
    \item ROS 2 Humble Hawksbill
    \item Docker Jammy 22.04 Stable
    \item Gazebo Simulator Classic
\end{itemize}
