...
No pacote ROS2 criado (localizado em /tcc) está uma versão modificada do arquivo turtlebot3\_absolute\_move.py (turtlebot3\_absolute\_move\_Arena.py, localizada em /tcc/tcc), que é utilizado na movimentação dos robôs patrulheiros. 
