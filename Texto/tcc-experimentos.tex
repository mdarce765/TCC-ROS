...
\begin{figure}
    \caption{Arena base com robô TurtleBot3 Burger}
    \includegraphics[width=0.45\linewidth]{Figures/Arena/ArenaBase.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda: Trajeto realizado pelo robô está representado em verde.}
    \label{fig:AB}
\end{figure}
...
\begin{figure}[htb]
    ...
    \caption*{Fonte: Autores}
    \caption*{Legenda: As retas em vermelho são os trajetos realizados pelos patrulheiros, enquanto a curva em verde, representa o trajeto do robô.}
    \label{fig:AP}
\end{figure}
