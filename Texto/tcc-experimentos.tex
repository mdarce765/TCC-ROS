...
%o que infelizmente não ocorreu. O modelo da arena foi fornecido pelo professor da instituição, Fagner Pimentel, que forneceu o arquivo ".sdf" utilizado.
...
\begin{figure}[htb]
    ...
    \caption{Resultados dos testes representados em gráficos.}
    \label{fig:GResultados}
\end{figure}