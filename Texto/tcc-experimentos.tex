...
\textcolor{red}{Foi descoberto que o FastDDS (middleware utilizado por padrão pelo ROS 2 Humble) não interage de forma consistente com Docker. Ele era capaz de compartilhar os tópicos entre os ambientes, mas causava falha na publicação e recebimento de mensagens, não mostrando nenhuma.} \textcolor{blue}{(Figura \ref{fig:tpf})} \textcolor{green}{DESENVOLVER}

\begin{figure}[htb]
    \caption{Falha no teste padrão}
    \includegraphics[width=1\linewidth]{Figures/TestePadraoFalha.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda: O terminal à esquerda é o host com implementação padrão (FastDDS), enquanto o terminal à direita está utilizando o Docker com implementação padrão (FastDDS).}
    \label{fig:tpf}
\end{figure}

\begin{figure}[htb]
    \caption{Sucesso no teste com CycloneDDS}
    \includegraphics[width=1\linewidth]{Figures/TesteCycloneSucesso.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda: O terminal à esquerda é o host com implementação padrão (FastDDS), o terminal à direita utiliza o Docker com implementação rmw\_cyclonedds\_cpp.}
    \label{fig:tcs}
\end{figure}
...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.45\linewidth]{Figures/Arena/ArenaPatrulheiros.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda: As retas em vermelho são os trajetos realizados pelos patrulheiros}
    \label{fig:AP}
\end{figure}
...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.45\linewidth]{Figures/Arena/ArenaLabirinto1.png}
    \caption*{Fonte: Autores}
    \label{fig:AL1}
\end{figure}
...
\begin{figure}[htb]
    ...
    \includegraphics[width=0.45\linewidth]{Figures/Arena/ArenaLabirinto2.png}
    \caption*{Fonte: Autores}
    \label{fig:AL2}
\end{figure}
...
\begin{comment}
% GRÁFICOS DE BANDA
\textbf{Gráficos com banda de erro}
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_cpu-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABNCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_mem-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABNMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_net-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABNNET}
\end{figure}
...
% GRÁFICO DE BARRA
\begin{figure}[htb]
    \caption*{\textbf{Gráfico de barra}}
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: CPU}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_cpu-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Memória RAM}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_mem-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Rede}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_net-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRNET}
\end{figure}
...
% TESTES T
\begin{figure}[htb]
    \caption*{\textbf{Teste T}}
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: CPU}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_cpu-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Memória RAM}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_mem-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Rede}
    \includegraphics[width=0.5\linewidth]{Figures/novaArena/arena_net-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATNET}
\end{figure}
...
% GRÁFICO DE BANDA
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_cpu-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBNCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_mem-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBNMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_net-band.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBNNET}
\end{figure}
...
\begin{figure}[htb]
    \caption*{\textbf{Gráfico de barra}}
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: CPU}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_cpu-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Memória RAM}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_mem-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Rede}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_net-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRNET}
\end{figure}
...
\begin{figure}[htb]
    \caption*{\textbf{Teste T}}
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: CPU}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_cpu-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Memória RAM}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_mem-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Rede}
    \includegraphics[width=0.5\linewidth]{Figures/novaPatrulha/patrulha_net-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTNET}
\end{figure}
