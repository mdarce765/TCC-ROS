...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_cpu-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_mem-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_net-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GABRNET}
\end{figure}
...
% TESTES T
\textbf{Gráfico teste T}
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_cpu-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_mem-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena base com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaArena/arena_net-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GATNET}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_cpu-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_mem-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_net-bars.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPBRNET}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: CPU}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_cpu-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTCPU}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Memória RAM}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_mem-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTMEM}
\end{figure}
...
\begin{figure}[htb]
    \caption{Gráfico da métrica de porcentagem de uso total dos testes na arena com robôs patrulheiros com e sem Docker: Rede}
    \includegraphics[width=0.7\linewidth]{Figures/novaPatrulha/patrulha_net-ttest.png}
    \caption*{Fonte: Autores}
    \caption*{Legenda:}
    \label{fig:GPTNET}
\end{figure}
