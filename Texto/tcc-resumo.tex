...
\textcolor{red}{serão} \textcolor{blue}{foram} 
realizados no ambiente simulado do software Gazebo Classic. Os resultados mostram que o desempenho da simulação não é impactado pelo uso do Docker, que ocorre um pequeno aumento do uso de memória, porém sem variações significativas no uso do processador, indicando que a simulação usando containers é viável durante o processo de desenvolvimento.
