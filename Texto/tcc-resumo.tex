...
\novo{Os resultados mostram que apesar do aumento do uso de memória e da uma variação significativa do uso de processador (segundo o Teste T realizado), o desempenho na simulação não é impactado pelo uso do Docker},
