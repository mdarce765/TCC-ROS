...
\textcolor{red}{Foram utilizados scripts bash\footnote{As configurações e arquivos para facilitar o setup estão presentes no repositório \url{https://github.com/joca2511/TCC_Docker}} para tornar a execução dos testes consistente, tendo cada parte do teste também em scripts, facilitando a criação\/modificação de testes personalizados. Foi criado um pacote ROS 2 (TCC)} \textcolor{green}{DESENVOLVER} 
