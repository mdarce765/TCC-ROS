...
\textcolor{blue}{As carecteristicas de isolamento e empacotamento são extremamente importantes para este trabalho, pois é necessário entender se essa camada adicional introduz atrasos, consumo excessivo de recursos ou variações no desempenho do robô. a partir deste conceito, aplica-se o Docker que foi utilizado para fazer a conteinerização,} o 
