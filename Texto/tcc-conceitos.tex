...
Para realizar os testes no robô simulado, será utilizado o Robot Operating System 2 (ROS 2), que é um meta-sistema operacional 
...
Os testes simulados foram executados em modelos baseados na arena presente na sala K4-04 do Centro Universitário FEI, para isso, será utilizado o software
Gazebo Simulator Classic que é um software usado para desenvolver simulações, possui diversos projetos de código aberto para que os interessados possam utilizar e desenvolver suas próprias simulações. Neste software estão presentes também diversos modelos, tanto como objetos como também robôs (Figura \ref{fig:gzb25}). Para realizar estes testes, será utilizado o modelo virtual do robô 
...
\begin{figure}[htb]
    ...
    \caption{Exemplo do ROS 2, utilizando turtlesim, ROS e RQT. Fonte: Autores}
    \label{fig:ROS25}
\end{figure}
\newpage
\begin{figure}[htb]
    ...
    \caption{Exemplo do Gazebo Simulator Classic com a arena Presente na K4-04. Fonte: Autores}
    \label{fig:gzb25}
\end{figure}
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.28\linewidth]{Figures/TurtleBot3.jpg}
    \caption{TurtleBot3 Burger. Fonte: FOUNDATION, 2025}
    \label{fig:tbt3b25}
\end{figure}