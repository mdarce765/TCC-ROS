...
\begin{figure}[htb]
    ...
    \caption{Exemplo do ROS 2, utilizando turtlesim, ROS e RQT. Fonte: Autores, 2025}
    \label{fig:ROS25}
\end{figure}
\newpage
\begin{figure}[htb]
    ...
    \caption{Exemplo do Gazebo Simulator Classic com a arena Presente na K4-04. Fonte: Autores, 2025}
    \label{fig:gzb25}
\end{figure}
\begin{figure}[htb]
    \centering
