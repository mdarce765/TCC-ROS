...
\textcolor{red}{Este projeto auxilia no entendimento com relação aos tipos de testes que podem ser realizados para analisar o desempenho do Docker, auxiliando de uma maneira que possa ser um pontapé inicial para o desenvolvimento dos testes com o Docker, e como medir o desempenho de um contêiner}
\textcolor{blue}{O projeto evidencia como o Docker executa, sendo afetado por diferentes sistemas operacionais, mostrando que um contêiner Docker para Windows sofre bastante com o desempenho, mostrando que a melhor opção é primariamente o macOS e, em seguida, o Linux. Estes dados auxiliaram no entendimento de que, para este projeto, a melhor opção é o uso de um contêiner Linux (pela falta de acesso a dispositivos com macOS e melhor desempenho que o Windows) para que assim possa ser aplicado em um robô e para que se possa realizar os testes de desempenho para realizar a comparação desejada}. \cite{SMKD2024}
